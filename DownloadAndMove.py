...
from_dir = "C:/Users/PC/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/PC/Documents/downlode files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
